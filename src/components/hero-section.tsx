    ...
    <section className="py-24 sm:py-32 md:py-40">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-400 sm:text-xl md:text-2xl">
          An engineering environment to create, test, and verify high-fidelity
          prompts that make LLMs follow instructions to the letter.
        </p>
        <div className="mt-10 flex justify-center gap-4">
          <Link href="/studio">
            <Button size="lg" className="text-base font-semibold cursor-pointer">
